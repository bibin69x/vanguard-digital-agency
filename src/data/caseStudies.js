export const CASE_STUDIES = [
  {
    ...
    clientName: "Real Estate & Housing Brand",
    tagline: "Scaling Qualified Buyer Inquiries via Targeted Meta & Google Ads",
    metrics: [
      { label: "Pipeline Generated", value: "₹45 Lakhs" },
      { label: "Cost per Lead (CPL)", value: "₹420" },
  ...
  {
    id: "cs-skincare",
    industryId: "skincare-dermatology",
    clientName: "Skincare & Aesthetic Clinic",
    tagline: "Filling Appointment Calendars for Laser & Facial Aesthetics",
    metrics: [
      { label: "Monthly Revenue", value: "₹18 Lakhs" },
  ...
  {
    id: "cs-ayurveda",
    industryId: "ayurveda-hospital",
    clientName: "Ayurvedic Wellness Retreat",
    tagline: "In-Patient Panchakarma & Wellness Package Booking Funnel",
    metrics: [
      { label: "In-Patient Packages", value: "85+ /mo" },
      { label: "Organic Search Lift", value: "+320%" },
  ...
  {
    id: "cs-dental",
    industryId: "hospitals-dental",
    clientName: "Dental & Implant Clinic",
    tagline: "Acquiring High-Value Dental Implant & Invisalign Patients",
    metrics: [
      { label: "Implant Leads / Mo", value: "120+" },
  ...
  },
  {
    ...
    clientName: "Car Rental & Fleet Service",
    tagline: "Maximizing Vehicle Fleet Occupancy via Urgent Search PPC",
    metrics: [
      { label: "Fleet Occupancy", value: "88%" },
  ...
  {
    id: "cs-edtech",
    industryId: "educational-brands",
    clientName: "Educational & Coaching Institute",
    tagline: "Student Admission & Course Workshop Scaling",
    metrics: [
      { label: "Admissions Filled", value: "450+" },
  ...
  },
  {
    ...
    tagline: "Turn-Key Interior Design Contracts via Aesthetic Meta Ads",
    metrics: [
      { label: "Project Pipeline", value: "₹28 Lakhs" },
      { label: "Inquiry Quality Lift", value: "+180%" },
  ...
  {
    id: "cs-ca",
    industryId: "chartered-accountant",
    clientName: "Chartered Accountant Firm",
    tagline: "B2B Corporate Retainers via Targeted LinkedIn & Search PPC",
    metrics: [
      { label: "Corporate Retainers", value: "+18 New" },
      { label: "Avg Annual Retainer", value: "₹1.2 Lakhs/yr" },
